...
--               d:/workspace/gittea-work/v2025/CYAN-FPGA/xdaq_top/source/ip/clk_ctrl/clk_ctrl_sim_netlist.vhdl
-- Design      : clk_ctrl
...
end clk_ctrl_clk_wiz;

architecture STRUCTURE of clk_ctrl_clk_wiz is
...
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_clk_ctrl,
      CLKFBOUT => clkfbout_clk_ctrl,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_clk_ctrl,
      CLKIN2 => '0',
      CLKINSEL => '1',
...
entity clk_ctrl is
  ...
  attribute NotValidForBitStream of clk_ctrl : entity is true;
end clk_ctrl;

architecture STRUCTURE of clk_ctrl is
begin
inst: entity work.clk_ctrl_clk_wiz
     port map (
      c0 => c0,
      c1 => c1,
      clk_in1_n => clk_in1_n,
